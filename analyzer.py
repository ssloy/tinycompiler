...
def decorate(ast):
    ...
    process_scope(ast, symtable) # N.B.: the decoration is made in two passes, necessary to propagate context to the function calls
    process_scope(ast, symtable) # for the functions defined later on
